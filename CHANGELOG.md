...
### Released
- Published **kinetic-flightdeck** as a public, portfolio-grade system focused on mcp governance.
...
### Shipped
- Cut the first coherent internal version of **kinetic-flightdeck** with stable domain objects, review surfaces, and decision outputs.
